...
class test_settings(unittest.TestCase):
    ...
    def test_settings_manager_open_fail(self):
       ...
       # Действие
       manager1.open("C:/Users/Costo/OneDrive/Документы/GitHub/design-patterns2/project/data/settings0.json")
    ...
    def test_settings_manager_open(self):
       ...
       # Действие
       result = manager1.open("C:/Users/Costo/OneDrive/Документы/GitHub/design-patterns2/project/data/settings.json")
    ...
    def test_settings_manager_singletone(self):
       # Подготовка
       manager1 = settings_manager()
       result = manager1.open("C:/Users/Costo/OneDrive/Документы/GitHub/design-patterns/project/data/settings.json")
